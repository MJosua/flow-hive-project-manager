CREATE TABLE t_team (
  ...
  FOREIGN KEY (team_leader_id) REFERENCES t_users(user_id)
);
...
CREATE TABLE t_task_dependencies (
  ...
  FOREIGN KEY (depends_on_task_id) REFERENCES t_tasks(task_id)
);
...
CREATE TABLE t_approval_workflows (
  ...
  FOREIGN KEY (submitted_by) REFERENCES t_users(user_id)
);
...
CREATE TABLE t_task_approvals (
  ...
  FOREIGN KEY (workflow_id) REFERENCES t_approval_workflows(workflow_id),
  FOREIGN KEY (task_id) REFERENCES t_tasks(task_id),
  FOREIGN KEY (approver_id) REFERENCES t_users(user_id)
);
